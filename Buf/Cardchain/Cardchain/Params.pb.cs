...
namespace Cardchain.Cardchain {
  ...
  public static partial class ParamsReflection {
    ...
    static ParamsReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "CiBjYXJkY2hhaW4vY2FyZGNoYWluL3BhcmFtcy5wcm90bxITY2FyZGNoYWlu",
            "LmNhcmRjaGFpbhoRYW1pbm8vYW1pbm8ucHJvdG8aFGdvZ29wcm90by9nb2dv",
            "LnByb3RvGh5jb3Ntb3MvYmFzZS92MWJldGExL2NvaW4ucHJvdG8i7wkKBlBh",
            "cmFtcxI+Chp2b3RpbmdSaWdodHNFeHBpcmF0aW9uVGltZRgBIAEoA1Iadm90",
            "aW5nUmlnaHRzRXhwaXJhdGlvblRpbWUSGAoHc2V0U2l6ZRgCIAEoBFIHc2V0",
            "U2l6ZRI7CghzZXRQcmljZRgDIAEoCzIZLmNvc21vcy5iYXNlLnYxYmV0YTEu",
            "Q29pbkIEyN4fAFIIc2V0UHJpY2USKgoQYWN0aXZlU2V0c0Ftb3VudBgEIAEo",
            "BFIQYWN0aXZlU2V0c0Ftb3VudBJHCg5zZXRDcmVhdGlvbkZlZRgFIAEoCzIZ",
            "LmNvc21vcy5iYXNlLnYxYmV0YTEuQ29pbkIEyN4fAFIOc2V0Q3JlYXRpb25G",
            "ZWUSTQoRY29sbGF0ZXJhbERlcG9zaXQYBiABKAsyGS5jb3Ntb3MuYmFzZS52",
            "MWJldGExLkNvaW5CBMjeHwBSEWNvbGxhdGVyYWxEZXBvc2l0EiIKDHdpbm5l",
            "clJld2FyZBgHIAEoA1IMd2lubmVyUmV3YXJkEkMKDGhvdXJseUZhdWNldBgJ",
            "IAEoCzIZLmNvc21vcy5iYXNlLnYxYmV0YTEuQ29pbkIEyN4fAFIMaG91cmx5",
            "RmF1Y2V0EiQKDWluZmxhdGlvblJhdGUYCiABKAlSDWluZmxhdGlvblJhdGUS",
            "IgoMcmFyZXNQZXJQYWNrGAsgASgEUgxyYXJlc1BlclBhY2sSJgoOY29tbW9u",
            "c1BlclBhY2sYDCABKARSDmNvbW1vbnNQZXJQYWNrEioKEHVuQ29tbW9uc1Bl",
            "clBhY2sYDSABKARSEHVuQ29tbW9uc1BlclBhY2sSIAoLdHJpYWxQZXJpb2QY",
            "DiABKARSC3RyaWFsUGVyaW9kEiQKDWdhbWVWb3RlUmF0aW8YDyABKANSDWdh",
            "bWVWb3RlUmF0aW8SSAofY2FyZEF1Y3Rpb25QcmljZVJlZHVjdGlvblBlcmlv",
            "ZBgQIAEoA1IfY2FyZEF1Y3Rpb25QcmljZVJlZHVjdGlvblBlcmlvZBJDCgxh",
            "aXJEcm9wVmFsdWUYESABKAsyGS5jb3Ntb3MuYmFzZS52MWJldGExLkNvaW5C",
            "BMjeHwBSDGFpckRyb3BWYWx1ZRI0ChVhaXJEcm9wTWF4QmxvY2tIZWlnaHQY",
            "EiABKANSFWFpckRyb3BNYXhCbG9ja0hlaWdodBJJCg90cmlhbFZvdGVSZXdh",
            "cmQYEyABKAsyGS5jb3Ntb3MuYmFzZS52MWJldGExLkNvaW5CBMjeHwBSD3Ry",
            "aWFsVm90ZVJld2FyZBIqChB2b3RlUG9vbEZyYWN0aW9uGBQgASgDUhB2b3Rl",
            "UG9vbEZyYWN0aW9uEigKD3ZvdGluZ1Jld2FyZENhcBgIIAEoA1IPdm90aW5n",
            "UmV3YXJkQ2FwEioKEG1hdGNoV29ya2VyRGVsYXkYFSABKARSEG1hdGNoV29y",
            "a2VyRGVsYXkSJAoNcmFyZURyb3BSYXRpbxgWIAEoBFINcmFyZURyb3BSYXRp",
            "bxIyChRleGNlcHRpb25hbERyb3BSYXRpbxgXIAEoBFIUZXhjZXB0aW9uYWxE",
            "cm9wUmF0aW8SKAoPdW5pcXVlRHJvcFJhdGlvGBggASgEUg91bmlxdWVEcm9w",
            "UmF0aW86JeigHwGK57AqHGNhcmRjaGFpbi94L2NhcmRjaGFpbi9QYXJhbXNC",
            "zwEKF2NvbS5jYXJkY2hhaW4uY2FyZGNoYWluQgtQYXJhbXNQcm90b1ABWjpn",
            "aXRodWIuY29tL0RlY2VudHJhbENhcmRnYW1lL2NhcmRjaGFpbi9jYXJkY2hh",
            "aW4vY2FyZGNoYWluogIDQ0NYqgITQ2FyZGNoYWluLkNhcmRjaGFpbsoCE0Nh",
            "cmRjaGFpblxDYXJkY2hhaW7iAh9DYXJkY2hhaW5cQ2FyZGNoYWluXEdQQk1l",
            "dGFkYXRh6gIUQ2FyZGNoYWluOjpDYXJkY2hhaW5iBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::Amino.AminoReflection.Descriptor, global::Gogoproto.GogoReflection.Descriptor, global::Cosmos.Base.V1beta1.CoinReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Cardchain.Cardchain.Params), global::Cardchain.Cardchain.Params.Parser, new[]{ "VotingRightsExpirationTime", "SetSize", "SetPrice", "ActiveSetsAmount", "SetCreationFee", "CollateralDeposit", "WinnerReward", "HourlyFaucet", "InflationRate", "RaresPerPack", "CommonsPerPack", "UnCommonsPerPack", "TrialPeriod", "GameVoteRatio", "CardAuctionPriceReductionPeriod", "AirDropValue", "AirDropMaxBlockHeight", "TrialVoteReward", "VotePoolFraction", "VotingRewardCap", "MatchWorkerDelay", "RareDropRatio", "ExceptionalDropRatio", "UniqueDropRatio" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::Cardchain.Cardchain.ParamsReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    public Params(Params other) : this() {
      ...
      setPrice_ = other.setPrice_ != null ? other.setPrice_.Clone() : null;
      activeSetsAmount_ = other.activeSetsAmount_;
      setCreationFee_ = other.setCreationFee_ != null ? other.setCreationFee_.Clone() : null;
      collateralDeposit_ = other.collateralDeposit_ != null ? other.collateralDeposit_.Clone() : null;
      winnerReward_ = other.winnerReward_;
      hourlyFaucet_ = other.hourlyFaucet_ != null ? other.hourlyFaucet_.Clone() : null;
      ...
      airDropValue_ = other.airDropValue_ != null ? other.airDropValue_.Clone() : null;
      airDropMaxBlockHeight_ = other.airDropMaxBlockHeight_;
      trialVoteReward_ = other.trialVoteReward_ != null ? other.trialVoteReward_.Clone() : null;
    ...
    private global::Cosmos.Base.V1beta1.Coin setPrice_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::Cosmos.Base.V1beta1.Coin SetPrice {
    ...
    private global::Cosmos.Base.V1beta1.Coin setCreationFee_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::Cosmos.Base.V1beta1.Coin SetCreationFee {
      get { return setCreationFee_; }
      set {
        setCreationFee_ = value;
      }
    }

    /// <summary>Field number for the "collateralDeposit" field.</summary>
    public const int CollateralDepositFieldNumber = 6;
    private global::Cosmos.Base.V1beta1.Coin collateralDeposit_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::Cosmos.Base.V1beta1.Coin CollateralDeposit {
      get { return collateralDeposit_; }
      set {
        collateralDeposit_ = value;
      }
    }
    ...
    private global::Cosmos.Base.V1beta1.Coin hourlyFaucet_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::Cosmos.Base.V1beta1.Coin HourlyFaucet {
    ...
    private global::Cosmos.Base.V1beta1.Coin airDropValue_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::Cosmos.Base.V1beta1.Coin AirDropValue {
    ...
    private global::Cosmos.Base.V1beta1.Coin trialVoteReward_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::Cosmos.Base.V1beta1.Coin TrialVoteReward {
      get { return trialVoteReward_; }
      set {
        trialVoteReward_ = value;
      }
    }
    ...
    public bool Equals(Params other) {
      ...
      if (!object.Equals(SetPrice, other.SetPrice)) return false;
      if (ActiveSetsAmount != other.ActiveSetsAmount) return false;
      if (!object.Equals(SetCreationFee, other.SetCreationFee)) return false;
      if (!object.Equals(CollateralDeposit, other.CollateralDeposit)) return false;
      if (WinnerReward != other.WinnerReward) return false;
      if (!object.Equals(HourlyFaucet, other.HourlyFaucet)) return false;
      ...
      if (!object.Equals(AirDropValue, other.AirDropValue)) return false;
      if (AirDropMaxBlockHeight != other.AirDropMaxBlockHeight) return false;
      if (!object.Equals(TrialVoteReward, other.TrialVoteReward)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (setPrice_ != null) hash ^= SetPrice.GetHashCode();
      if (ActiveSetsAmount != 0UL) hash ^= ActiveSetsAmount.GetHashCode();
      if (setCreationFee_ != null) hash ^= SetCreationFee.GetHashCode();
      if (collateralDeposit_ != null) hash ^= CollateralDeposit.GetHashCode();
      if (WinnerReward != 0L) hash ^= WinnerReward.GetHashCode();
      if (hourlyFaucet_ != null) hash ^= HourlyFaucet.GetHashCode();
      ...
      if (airDropValue_ != null) hash ^= AirDropValue.GetHashCode();
      if (AirDropMaxBlockHeight != 0L) hash ^= AirDropMaxBlockHeight.GetHashCode();
      if (trialVoteReward_ != null) hash ^= TrialVoteReward.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (setPrice_ != null) {
        ...
        output.WriteMessage(SetPrice);
      }
      if (ActiveSetsAmount != 0UL) {
        output.WriteRawTag(32);
        output.WriteUInt64(ActiveSetsAmount);
      }
      if (setCreationFee_ != null) {
        output.WriteRawTag(42);
        output.WriteMessage(SetCreationFee);
      }
      if (collateralDeposit_ != null) {
        output.WriteRawTag(50);
        output.WriteMessage(CollateralDeposit);
      }
      if (WinnerReward != 0L) {
      ...
      if (hourlyFaucet_ != null) {
        output.WriteRawTag(74);
        output.WriteMessage(HourlyFaucet);
      }
      ...
      if (airDropValue_ != null) {
        output.WriteRawTag(138, 1);
        output.WriteMessage(AirDropValue);
      }
      if (AirDropMaxBlockHeight != 0L) {
        output.WriteRawTag(144, 1);
        output.WriteInt64(AirDropMaxBlockHeight);
      }
      if (trialVoteReward_ != null) {
        output.WriteRawTag(154, 1);
        output.WriteMessage(TrialVoteReward);
      }
    ...
    public int CalculateSize() {
      ...
      if (setPrice_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(SetPrice);
      }
      if (ActiveSetsAmount != 0UL) {
        size += 1 + pb::CodedOutputStream.ComputeUInt64Size(ActiveSetsAmount);
      }
      if (setCreationFee_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(SetCreationFee);
      }
      if (collateralDeposit_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(CollateralDeposit);
      }
      if (WinnerReward != 0L) {
        size += 1 + pb::CodedOutputStream.ComputeInt64Size(WinnerReward);
      }
      if (hourlyFaucet_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(HourlyFaucet);
      }
      if (InflationRate.Length != 0) {
      ...
      if (airDropValue_ != null) {
        size += 2 + pb::CodedOutputStream.ComputeMessageSize(AirDropValue);
      }
      if (AirDropMaxBlockHeight != 0L) {
        size += 2 + pb::CodedOutputStream.ComputeInt64Size(AirDropMaxBlockHeight);
      }
      if (trialVoteReward_ != null) {
        size += 2 + pb::CodedOutputStream.ComputeMessageSize(TrialVoteReward);
      }
      if (VotePoolFraction != 0L) {
    ...
    public void MergeFrom(Params other) {
      ...
      if (other.setPrice_ != null) {
        if (setPrice_ == null) {
          SetPrice = new global::Cosmos.Base.V1beta1.Coin();
        }
        SetPrice.MergeFrom(other.SetPrice);
      }
      if (other.ActiveSetsAmount != 0UL) {
        ActiveSetsAmount = other.ActiveSetsAmount;
      }
      if (other.setCreationFee_ != null) {
        if (setCreationFee_ == null) {
          SetCreationFee = new global::Cosmos.Base.V1beta1.Coin();
        }
        SetCreationFee.MergeFrom(other.SetCreationFee);
      }
      if (other.collateralDeposit_ != null) {
        if (collateralDeposit_ == null) {
          CollateralDeposit = new global::Cosmos.Base.V1beta1.Coin();
        }
        CollateralDeposit.MergeFrom(other.CollateralDeposit);
      }
      if (other.WinnerReward != 0L) {
        WinnerReward = other.WinnerReward;
      }
      if (other.hourlyFaucet_ != null) {
        if (hourlyFaucet_ == null) {
          HourlyFaucet = new global::Cosmos.Base.V1beta1.Coin();
        }
        HourlyFaucet.MergeFrom(other.HourlyFaucet);
      }
      ...
      if (other.airDropValue_ != null) {
        if (airDropValue_ == null) {
          AirDropValue = new global::Cosmos.Base.V1beta1.Coin();
        }
        AirDropValue.MergeFrom(other.AirDropValue);
      }
      if (other.AirDropMaxBlockHeight != 0L) {
        AirDropMaxBlockHeight = other.AirDropMaxBlockHeight;
      }
      if (other.trialVoteReward_ != null) {
        if (trialVoteReward_ == null) {
          TrialVoteReward = new global::Cosmos.Base.V1beta1.Coin();
        }
        TrialVoteReward.MergeFrom(other.TrialVoteReward);
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      switch(tag) {
          ...
          case 42: {
            ...
            input.ReadMessage(SetCreationFee);
            break;
          }
          case 50: {
            if (collateralDeposit_ == null) {
            ...
            input.ReadMessage(CollateralDeposit);
            break;
          }
          case 56: {
          ...
          case 74: {
            ...
            input.ReadMessage(HourlyFaucet);
            break;
          }
          case 82: {
          ...
          case 138: {
            ...
            input.ReadMessage(AirDropValue);
            break;
          }
          case 144: {
          ...
          case 154: {
            ...
            input.ReadMessage(TrialVoteReward);
            break;
          }
          case 160: {
