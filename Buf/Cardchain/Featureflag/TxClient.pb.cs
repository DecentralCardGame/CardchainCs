...
namespace Cardchain.Featureflag {
	...
	public class MsgClient {
        ...
        /// <summary>
      	/// SendMsgSet sends a MsgSet transaction to the blockchain and waits
      	/// for a response.
      	/// </summary>
      	/// <param name="msg">The MsgSet message that should be send.</param>
      	/// <param name="fee">The fees that will be paid.</param>
        [global::System.CodeDom.Compiler.GeneratedCode("protoc-gen-cosmos-csharp", null)]
        public Task<Cosmcs.Client.ClientResponse<MsgSetResponse>> SendMsgSet(MsgSet msg, Cosmcs.Tx.Fee? fee = null) {
			return Client.BuildAndBroadcast(new Any[] {
				new Any
				{
					Value = msg.ToByteString(),
			...
			.ContinueWith(r => new Cosmcs.Client.ClientResponse<MsgSetResponse>(
				r.Result,
				MsgSetResponse.Parser
			));
		}

		/// <summary>
      	/// SimulateMsgSet simulates a MsgSet transaction on the blockchain.
      	/// </summary>
      	/// <param name="msg">The MsgSet message that should be simulated.</param>
		[global::System.CodeDom.Compiler.GeneratedCode("protoc-gen-cosmos-csharp", null)]
		public Task<Cosmos.Tx.V1beta1.SimulateResponse> SimulateMsgSet(MsgSet msg) {
			return Client.BuildAndSimulate(new Any[] {
				new Any
				{
					Value = msg.ToByteString(),
		...
		/// <summary>
      	/// SimulateAndSendMsgSet simulates, estimates fees and then sends a Set transaction to the blockchain.
      	/// </summary>
      	/// <param name="msg">The MsgSet message that should be send.</param>
		[global::System.CodeDom.Compiler.GeneratedCode("protoc-gen-cosmos-csharp", null)]
		public Task<Cosmcs.Client.ClientResponse<MsgSetResponse>> SimulateAndSendMsgSet(MsgSet msg) {
			return SimulateMsgSet(msg).ContinueWith(r => {
				return SendMsgSet(msg, new Cosmcs.Tx.Fee((ulong) Math.Ceiling(r.Result.GasInfo.GasUsed * 1.5))).Result;
			});
		}
